...
export default function SignupPage() {
    return (
        <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col relative overflow-hidden font-sans">
            ...
            <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-rose-600/10 blur-[120px] rounded-full mix-blend-screen pointer-events-none"></div>
            <div className="absolute bottom-[-20%] right-[-10%] w-[40%] h-[40%] bg-teal-600/10 blur-[120px] rounded-full mix-blend-screen pointer-events-none"></div>
            ...
            <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-12 w-full max-w-md mx-auto">
                ...
                <div className="w-full bg-slate-900/50 border border-slate-800/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl">
                    <div className="text-center mb-10">
                        <h1 className="text-3xl font-bold text-slate-100 mb-3">Create an account</h1>
